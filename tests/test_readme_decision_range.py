...
``test_decision_range_cites_latest_active`` and ``llm-eval-harness``
``test_readme_snapshot.py`` ``test_decision_range_cites_latest_active``.
...
loud — the same drift class that the architecture-doc-lock catches
