...
per push even though the in-flight run is immediately superseded. For
this repo's manually-dispatched `integration.yml`, the same applies to
an operator double-clicking Run-workflow or quickly redispatching with
different inputs — which double-bills the `LIVE_CACHE_BUDGET_USD`
ceiling.
...
Spec / origin: this repo's #60. Propagated from llm-eval-harness #64.
"""
